  ...
  return (
    <main className="menu-screen">
      <section className="menu-panel">
        ...
        <p>
          Ночная смена в архиве. Не открывай папку с красной печатью, проверяй камеры,
          выполняй задания и реши, что делать с делом №417.
        </p>
        ...
        {showInfo && (
          <section className="game-info">
            ...
            <p>
              Правило инвентаря: в руках можно держать только один предмет. Нажми Drop или Q, чтобы положить
              предмет на пол, потом подойди к нему и нажми E, чтобы снова взять.
            </p>
          </section>
        )}
      </section>
