...
3D-игра на React и Three.js: игрок исследует тёмный архив, собирает улики,
включает свет, следит за страхом и ищет правильную запись на мониторе камер.
...
- 3D-архив с управлением от первого лица.
- Сюжетные задания, журнал, улики, инвентарь и несколько концовок.
- Функция камер: в архиве есть монитор, где можно переключать записи камер и
  подтверждать правильную запись.
- Сохранение прогресса через Supabase для Google-аккаунта.
- Звуки, мобильное управление и HUD для игры.
